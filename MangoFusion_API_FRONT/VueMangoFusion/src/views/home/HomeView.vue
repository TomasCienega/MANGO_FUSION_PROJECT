      ...
      <div class="row g-3 my-4 border align-items-center shadow-sm rounded-4 mx-1 pt-1 p-3">
        ...
        <div class="col-lg-auto">
          <div class="d-flex flex-wrap gap-2">
            <button
              :class="{
                'btn-success shadow-sm': category === selectCategory,
        ...
        <div class="col-lg-auto order-1 order-lg-2 ms-lg-auto">
          <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end shadow-sm rounded-3">
              <li v-for="sort in SORT_OPTIONS" :key="sort">
                <button
...
import MenuItemDetailsModal from '@/modals/MenuItemDetailsModal.vue';
...
const isModalOpen = ref(false); // Controla si se ve el modal
const selectedItem = ref(null); // Guarda el objeto del platillo que clickeaste
...
const filteredItems = computed(() => {
  let tempArray =
    selectCategory.value == 'ALL'
      ? [...menuItems]
      : menuItems.filter(
          (item) => item.category.toUpperCase() === selectCategory.value.toUpperCase(),
        );
